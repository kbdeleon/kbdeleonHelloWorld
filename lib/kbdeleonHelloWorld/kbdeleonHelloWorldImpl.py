...
This sample module contains one small method that filters contigs.
    ...
    def run_kbdeleonHelloWorld(self, ctx, params):
        """
        ...
        #BEGIN run_kbdeleonHelloWorld

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_kbdeleonHelloWorld function. Params=' + pformat(params))
        ...
        #END run_kbdeleonHelloWorld

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_kbdeleonHelloWorld return value ' +
